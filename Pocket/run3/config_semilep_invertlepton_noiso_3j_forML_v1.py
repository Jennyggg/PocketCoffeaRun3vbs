...
import workflow_invertlepton_noiso_forML_v1, custom_cut_functions
from workflow_invertlepton_noiso_forML_v1 import VBSSemileptonicProcessor
...
cloudpickle.register_pickle_by_value(workflow_invertlepton_noiso_forML_v1)
...
cfg = Configurator(
    ...
    workflow_options = {"dump_columns_as_arrays_per_chunk": "root://eosuser.cern.ch//eos/user/j/jinw/VBS_forML/output_VBS_data2022postEE_deepmet_resolution_PTLLStitch_JetStitch_jet50_save_invertlepton_v1/"},
