...
import workflow_forML, custom_cut_functions
from workflow_forML import VBSSemileptonicProcessor
...
cloudpickle.register_pickle_by_value(workflow_forML)
...
cfg = Configurator(
    ...
    # 2) preselections 
    preselections=[vbs_semileptonic_w_pt_stitch_presel],
        ...
        "common": {
           "bycategory": {
               "resolved_mu": [
                   ...
                   ColOut("dphi",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_lepton1", "jet3_jet4", "jet3_lepton1", "jet4_lepton1", f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"lepton1_{METDef}"]),
                   ColOut("deta",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_lepton1", "jet3_jet4", "jet3_lepton1", "jet4_lepton1", f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"lepton1_{METDef}"]),
                   ],
               "resolved_e": [
                   ColOut("events",["nJetGood","nCentralJetsGood",MTDef, "z_lep","centrality_resolved","vbsjet1_PNetQvG","vbsjet2_PNetQvG","vbsjet1_DeepFlavQG","vbsjet2_DeepFlavQG","w_had_jet1_resolved_PNetQvG","w_had_jet2_resolved_PNetQvG","w_had_jet1_resolved_DeepFlavQG","w_had_jet2_resolved_DeepFlavQG","vbs_dR","dR_w_had_vbs1","dR_w_had_vbs2","lead_wlep_vbsjet1_dR"]),
                   ColOut(METDef, ["pt","phi"]),
