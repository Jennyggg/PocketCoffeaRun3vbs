...
cfg = Configurator(
    ...
    datasets={
        "jsons": [
            ...
            f"{localdir}/datasets/EGamma_E.json",
    ...
    weights_classes=common_weights+[SF_ele_trigger, QvGSFWeight, Tau21SFWeight],#+[PileupWeight],
    ...
    weights={"common": {"inclusive": ["genWeight", "lumi", "XS", "pileup", "sf_mu_id", "sf_mu_iso", "sf_ele_id", "sf_ele_reco","sf_mu_trigger","sf_ele_trigger","sf_btag","sf_qvg","sf_tau21"]}},
   ...
   variations={"weights": {"common": {"inclusive": ["pileup", "sf_mu_id","sf_mu_iso","sf_ele_id","sf_ele_reco","sf_mu_trigger","sf_ele_trigger","sf_btag","sf_qvg","sf_tau21"]}},
