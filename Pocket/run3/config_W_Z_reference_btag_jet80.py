...
import workflow_jet80, custom_cut_functions
from workflow_jet80 import VBSSemileptonicProcessor
from custom_cut_functions import (
    ...
    wjets_mu_sel,
    TT_mu_2bj_sel,
    TT_mu_1bj_4j_2central_sel,
    TT_mu_2bj_4j_2central_sel,
    TT_e_2bj_sel,
    TT_e_1bj_4j_2central_sel,
    TT_e_2bj_4j_2central_sel
)
...
cloudpickle.register_pickle_by_value(workflow_jet80)
...
cfg = Configurator(
    ...
    categories={
        ...
        "TT_mu_2bj_3central_reference": [TT_mu_2bj_sel],
        "TT_mu_1bj_4j_2central_reference": [TT_mu_1bj_4j_2central_sel],
        "TT_mu_2bj_4j_2central_reference": [TT_mu_2bj_4j_2central_sel],
        "TT_e_2bj_3central_reference": [TT_e_2bj_sel],
        "TT_e_1bj_4j_2central_reference": [TT_e_1bj_4j_2central_sel],
        "TT_e_2bj_4j_2central_reference": [TT_e_2bj_4j_2central_sel],
    },
    ...
    weights={"common": {"inclusive": ["lumi", "XS","pileup", "genWeight","sf_mu_id", "sf_mu_iso", "sf_ele_id", "sf_ele_reco","sf_mu_trigger","sf_ele_trigger","sf_btag"]}},
