...
import workflow_invertlepton_tighttomedium, custom_cut_functions
from workflow_invertlepton_tighttomedium import VBSSemileptonicProcessor
...
cloudpickle.register_pickle_by_value(workflow_invertlepton_tighttomedium)
...
parameters = defaults.merge_parameters_from_files(
    default_parameters,
    f"{localdir}/params/object_preselection_run3_invertlepton_tighttomedium.yaml",
    f"{localdir}/params/triggers.yaml",
    f"{localdir}/params/plotting.yaml",
    f"{localdir}/params/lumi.yaml",
    f"{localdir}/params/pileup.yaml",
    f"{localdir}/params/fakelepton_weights_tighttomedium.yaml",
    update=True,
)
...
cfg = Configurator(
    ...
    categories={
        ...
        "QCD_VR": [qcd_validate],
        "QCD_VR_e": [qcd_validate_e],
        "QCD_VR_mu": [qcd_validate_mu],
        "QCD_VR_0j": [qcd_validate_0j],
        "QCD_VR_0j_e": [qcd_validate_0j_e],
        "QCD_VR_0j_mu": [qcd_validate_0j_mu],
    ...
    weights={"common": {"inclusive": ["genWeight", "lumi", "XS", "pileup", "sf_mu_id", "sf_mu_iso", "sf_ele_id", "sf_ele_reco","sf_mu_trigger","sf_ele_trigger","muon_inverttight_to_fake","electron_inverttight_to_fake"]}},
    variations={"weights": {"common": {"inclusive": ["pileup", "sf_mu_id","sf_mu_iso","sf_ele_id","sf_ele_reco","sf_mu_trigger","sf_ele_trigger","muon_inverttight_to_fake","electron_inverttight_to_fake"]}}}, #"pileup"
    #weights={
    #        "common": {
