...
import workflow_evaluateML_test1, custom_cut_functions
from workflow_evaluateML_test1 import VBSSemileptonicProcessor
...
cloudpickle.register_pickle_by_value(workflow_evaluateML_test1)
