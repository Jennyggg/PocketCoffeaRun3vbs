...
cfg = Configurator(
    ...
    weights={"common": {"inclusive": ["lumi", "XS", "genWeight","sf_mu_id", "sf_mu_iso", "sf_ele_id", "sf_ele_reco","sf_mu_trigger"]}},
    variations={"weights": {"common": {"inclusive": ["sf_mu_id","sf_mu_iso","sf_ele_id","sf_ele_reco","sf_mu_trigger"]}}},
