...
import workflow_invertlepton_noiso_evaluateML_jet80, custom_cut_functions
from workflow_invertlepton_noiso_evaluateML_jet80 import VBSSemileptonicProcessor
...
cloudpickle.register_pickle_by_value(workflow_invertlepton_noiso_evaluateML_jet80)
