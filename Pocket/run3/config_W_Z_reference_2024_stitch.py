...
cfg = Configurator(
    ...
    datasets={
        "jsons": [
            ...
            ## 2024 BKG
            ########
            #f"{localdir}/datasets/WtoMuNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            #f"{localdir}/datasets/WtoENu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            #f"{localdir}/datasets/WtoTauNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            #f"{localdir}/datasets/DYto2Mu-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            #f"{localdir}/datasets/DYto2E-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            #f"{localdir}/datasets/DYto2Tau-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoENu-2Jets_Bin-0J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoMuNu-2Jets_Bin-0J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoTauNu-2Jets_Bin-0J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-1J-PTLNu-40to100_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-1J-PTLNu-40to100_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-1J-PTLNu-100to200_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-1J-PTLNu-200to400_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-1J-PTLNu-400to600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-1J-PTLNu-600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-2J-PTLNu-40to100_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-2J-PTLNu-40to100_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-2J-PTLNu-100to200_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-2J-PTLNu-200to400_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-2J-PTLNu-400to600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/WtoLNu-2Jets_Bin-2J-PTLNu-600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2E-2Jets_Bin-0J-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2Mu-2Jets_Bin-0J-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2Tau-2Jets_Bin-0J-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-1J-MLL-50-PTLL-40to100_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-1J-MLL-50-PTLL-100to200_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-1J-MLL-50-PTLL-200to400_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-1J-MLL-50-PTLL-400to600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-1J-MLL-50-PTLL-600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-2J-MLL-50-PTLL-40to100_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-2J-MLL-50-PTLL-100to200_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-2J-MLL-50-PTLL-200to400_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-2J-MLL-50-PTLL-400to600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/DYto2L-2Jets_Bin-2J-MLL-50-PTLL-600_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json",
            f"{localdir}/datasets/TTtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8.json",
            # #########
            # ## RUN 3 SIGNAL
            # ########
            ...
            f"{localdir}/datasets/EGamma0_2024C.json", # 2022_postEE EGamma
            f"{localdir}/datasets/EGamma1_2024C.json", 
            f"{localdir}/datasets/Muon0_2024C.json",
            f"{localdir}/datasets/Muon1_2024C.json"
        ...
        "filter": {
            ...
            "DYto2E-2Jets_Bin-0J-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8",
            "DYto2Mu-2Jets_Bin-0J-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8",
    ...
    categories={
        ...
        "wjets_reference": [wjets_sel],
        "wjets_e_reference": [wjets_e_sel],
        "wjets_mu_reference": [wjets_mu_sel],
        "zjets_reference": [zjets_sel],
        "zjets_e_reference": [zjets_e_sel],
        "zjets_mu_reference": [zjets_mu_sel],
    },
    ...
    weights={"common": {"inclusive": ["lumi", "XS", "pileup","genWeight","sf_mu_id", "sf_mu_iso", "sf_ele_id", "sf_ele_reco","sf_mu_trigger"]}},
    variations={"weights": {"common": {"inclusive": ["pileup","sf_mu_id","sf_mu_iso","sf_ele_id","sf_ele_reco","sf_mu_trigger"]}}},
    ...
    variables={
        ...
        #"genWeight":     HistConf([Axis(coll="events", field="genWeight", bins=400, start=-0.01, stop=0.01, label="PSWeight")]),
        ...
        "m_ll":   HistConf([Axis(coll="ll", field="m_ll", bins=100, start=0, stop=200.0, label=r"$m_{ll}$ [GeV]")]),
        # lead lepton dR
        ...
        "w_had_jet1_resolved_PNetQvG": HistConf([Axis(coll="events", field="w_had_jet1_resolved_PNetQvG", bins=40, start=0, stop=1.0, label=r"$ParticleNetQvG(W^{had.} j_1)$")]),
        "w_had_jet2_resolved_PNetQvG": HistConf([Axis(coll="events", field="w_had_jet2_resolved_PNetQvG", bins=40, start=0, stop=1.0, label=r"$ParticleNetQvG(W^{had.} j_2)$")]),
        "w_had_jet1_resolved_DeepFlavQG": HistConf([Axis(coll="events", field="w_had_jet1_resolved_DeepFlavQG", bins=40, start=0, stop=1.0, label=r"$DeepJetGvQ(W^{had.} j_1)$")]),
        "w_had_jet2_resolved_DeepFlavQG": HistConf([Axis(coll="events", field="w_had_jet2_resolved_DeepFlavQG", bins=40, start=0, stop=1.0, label=r"$DeepJetGvQ(W^{had.} j_2)$")]),
        ...
        "PNetQvG_vbsjet1":  HistConf([Axis(coll="events", field="vbsjet1_PNetQvG", bins=50, start=0, stop=1, label=r"$ParticleNetQvG(j_1)^{VBS}$")]),
        "PNetQvG_vbsjet2":  HistConf([Axis(coll="events", field="vbsjet1_PNetQvG", bins=50, start=0, stop=1, label=r"$ParticleNetQvG(j_2)^{VBS}$")]),
        "DeepFlavQG_vbsjet1":  HistConf([Axis(coll="events", field="vbsjet1_DeepFlavQG", bins=50, start=0, stop=1, label=r"$DeepJetGvQ(j_1)^{VBS}$")]),
        "DeepFlavQG_vbsjet2":  HistConf([Axis(coll="events", field="vbsjet1_DeepFlavQG", bins=50, start=0, stop=1, label=r"$DeepJetGvQ(j_2)^{VBS}$")]),
        ...
        "BJetIdx":       HistConf([Axis(coll="BJetLoose", field="idx", bins=10, start=-1, stop=10, label="BJet loose idx")]),
