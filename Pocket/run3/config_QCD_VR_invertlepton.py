...
import workflow_invertlepton, custom_cut_functions
from workflow_invertlepton import VBSSemileptonicProcessor
...
cloudpickle.register_pickle_by_value(workflow_invertlepton)
...
parameters = defaults.merge_parameters_from_files(
    ...
    f"{localdir}/params/fakelepton_weights_tighttoloose.yaml",
    update=True,
)
