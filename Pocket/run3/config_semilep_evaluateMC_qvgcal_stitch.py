...
import workflow_evaluate_qvgcal, custom_cut_functions
from workflow_evaluate_qvgcal import VBSSemileptonicProcessor
...
cfg = Configurator(
    ...
    weights_classes=common_weights+[SF_ele_trigger, QvGSFWeight],#+[PileupWeight],
    ...
    weights={"common": {"inclusive": ["genWeight", "lumi", "XS", "pileup", "sf_mu_id", "sf_mu_iso", "sf_ele_id", "sf_ele_reco","sf_mu_trigger","sf_ele_trigger","sf_btag","sf_qvg"]}},
   ...
   variations={"weights": {"common": {"inclusive": ["pileup", "sf_mu_id","sf_mu_iso","sf_ele_id","sf_ele_reco","sf_mu_trigger","sf_ele_trigger","sf_btag","sf_qvg"]}},
