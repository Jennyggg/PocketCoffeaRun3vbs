...
import workflow_forML_jet80, custom_cut_functions
from workflow_forML_jet80 import VBSSemileptonicProcessor
...
cloudpickle.register_pickle_by_value(workflow_forML_jet80)
...
cfg = Configurator(
   ...
   variations={"weights": {"common": {"inclusive": ["pileup", "sf_mu_id","sf_mu_iso","sf_ele_id","sf_ele_reco","sf_mu_trigger","sf_ele_trigger","sf_btag"]}},
    ...
    variables={
        ...
        "PNetQvG_vbsjet2":  HistConf([Axis(coll="events", field="vbsjet2_PNetQvG", bins=50, start=0, stop=1, label=r"$ParticleNetQvG(j_2)^{VBS}$")]),
        "DeepFlavQG_vbsjet1":  HistConf([Axis(coll="events", field="vbsjet1_DeepFlavQG", bins=50, start=0, stop=1, label=r"$DeepJetGvQ(j_1)^{VBS}$")]),
        "DeepFlavQG_vbsjet2":  HistConf([Axis(coll="events", field="vbsjet2_DeepFlavQG", bins=50, start=0, stop=1, label=r"$DeepJetGvQ(j_2)^{VBS}$")]),
        ...
        "common": {
           "bycategory": {
               "resolved_mu": [
                   ...
                   ColOut("jet1",["eta","phi","pt", "btagPNetQvG", "btagPNetQvG", "btagDeepFlavB"]),
                   ColOut("jet2",["eta","phi","pt", "btagPNetQvG", "btagPNetQvG", "btagDeepFlavB"]),
                   ColOut("jet3",["eta","phi","pt", "btagPNetQvG", "btagPNetQvG", "btagDeepFlavB"]),
                   ColOut("jet4",["eta","phi","pt", "btagPNetQvG", "btagPNetQvG", "btagDeepFlavB"]),
                   ColOut("jet5",["eta","phi","pt", "btagPNetQvG", "btagPNetQvG", "btagDeepFlavB"]),
                   ColOut("jet6",["eta","phi","pt", "btagPNetQvG", "btagPNetQvG", "btagDeepFlavB"]),
                   ColOut("lepton1",["eta","phi","pt"]),
                   ColOut("mass",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_jet5", "jet1_jet6", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_jet5", "jet2_jet6", "jet2_lepton1", "jet3_jet4", "jet3_jet5", "jet3_jet6", "jet3_lepton1", "jet4_jet5", "jet4_jet6", "jet4_lepton1", "jet5_jet6", "jet5_lepton1", "jet6_lepton1",f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"jet5_{METDef}",f"jet6_{METDef}",f"lepton1_{METDef}"]),
                   ColOut("dR",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_jet5", "jet1_jet6", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_jet5", "jet2_jet6", "jet2_lepton1", "jet3_jet4", "jet3_jet5", "jet3_jet6", "jet3_lepton1", "jet4_jet5", "jet4_jet6", "jet4_lepton1", "jet5_jet6", "jet5_lepton1", "jet6_lepton1",f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"jet5_{METDef}",f"jet6_{METDef}",f"lepton1_{METDef}"]),
                   ColOut("dphi",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_jet5", "jet1_jet6", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_jet5", "jet2_jet6", "jet2_lepton1", "jet3_jet4", "jet3_jet5", "jet3_jet6", "jet3_lepton1", "jet4_jet5", "jet4_jet6", "jet4_lepton1", "jet5_jet6", "jet5_lepton1", "jet6_lepton1",f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"jet5_{METDef}",f"jet6_{METDef}",f"lepton1_{METDef}"]),
                   ColOut("deta",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_jet5", "jet1_jet6", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_jet5", "jet2_jet6", "jet2_lepton1", "jet3_jet4", "jet3_jet5", "jet3_jet6", "jet3_lepton1", "jet4_jet5", "jet4_jet6", "jet4_lepton1", "jet5_jet6", "jet5_lepton1", "jet6_lepton1", f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"jet5_{METDef}",f"jet6_{METDef}",f"lepton1_{METDef}"])],
               "resolved_e": [
                   ColOut("events",["nJetGood","nCentralJetsGood",MTDef, "z_lep","centrality_resolved","vbsjet1_PNetQvG","vbsjet2_PNetQvG","vbsjet1_DeepFlavQG","vbsjet2_DeepFlavQG","w_had_jet1_resolved_PNetQvG","w_had_jet2_resolved_PNetQvG","w_had_jet1_resolved_DeepFlavQG","w_had_jet2_resolved_DeepFlavQG","vbs_dR","dR_w_had_vbs1","dR_w_had_vbs2","lead_wlep_vbsjet1_dR"]),
                   ColOut(METDef, ["pt","phi"]),
                   ColOut("w_had_jets", ["mass","pt","phi","eta"]),
               ...
               "boosted_mu": [
                   ...
                   ColOut("dphi",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_fatjet1", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_fatjet1", "jet2_lepton1", "jet3_jet4", "jet3_fatjet1", "jet3_lepton1", "jet4_fatjet1", "jet4_lepton1","lepton1_fatjet1",f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"{METDef}_fatjet1",f"lepton1_{METDef}"]),
                   ColOut("deta",["jet1_jet2", "jet1_jet3", "jet1_jet4", "jet1_fatjet1", "jet1_lepton1", "jet2_jet3", "jet2_jet4", "jet2_fatjet1", "jet2_lepton1", "jet3_jet4", "jet3_fatjet1", "jet3_lepton1", "jet4_fatjet1", "jet4_lepton1", "lepton1_fatjet1",f"jet1_{METDef}",f"jet2_{METDef}",f"jet3_{METDef}",f"jet4_{METDef}",f"{METDef}_fatjet1",f"lepton1_{METDef}"])
                   ],
               "boosted_e": [
                   ColOut("events",["nJetGood", "nCentralJetsGood", "nFatJetGood",MTDef,"z_lep","z_fat","centrality_boosted","vbsjet1_PNetQvG","vbsjet2_PNetQvG","vbsjet1_DeepFlavQG","vbsjet2_DeepFlavQG","vbs_dR","vbs1_fj_dR","vbs2_fj_dR","lead_wlep_vbsjet1_dR"]),
                   ColOut(METDef, ["pt","phi"]),
